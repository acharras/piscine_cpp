...
/*   Updated: 2021/06/29 14:11:46 by acharras         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
	os << "Trap class : \tCL4P-TP" << std::endl << "Trap name : \t" << i.getName() << std::endl 
	<< "Trap hit points : \t" << i.getHitPoints() << std::endl << "Trap energy points : \t" << i.getEnergyPoints() <<std::endl
	<< "Trap attack damage : \t" << i.getAttackDamage() << std::endl;
	return os;
}
